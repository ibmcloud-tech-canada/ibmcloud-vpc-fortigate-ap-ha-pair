...
variable RESOURCE_GROUP {
  type        = string
  description = "ID of resource group in which to put the instances and volumes" 
}
...
variable BOOT_ENCRYPTION_KEY {
  description = "Key Protect or HPCS encryption key crn for encrypting the boot disk."
  type = string
}
